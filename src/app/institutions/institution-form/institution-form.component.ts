  ...
  ngOnInit(): void {
    ...
    this.serviceProxy
      .getManyBaseCountryControllerCountry(
        ...
        console.log("country not assign ins----",this.listc)
      ...
      if (this.editInstitutionId > 0) {
        ...
        this.serviceProxy
          .getOneBaseInstitutionControllerInstitution(
            ...
            //this.listc = [];//not assigned list
            for(let x =0 ; x<res.countries.length; x++){
              this.listc.push(res.countries[x])

            }

            this.institution = res;
            console.log('edit institution----', res);
            console.log('edit institution-33333---', this.countryList);
